      ...
      <div className="grid flex-1 gap-4 lg:grid-cols-[minmax(240px,320px)_1fr_minmax(280px,360px)]">
        ...
        <div className="card flex flex-col items-center justify-center p-4">
          {clip.current_render_url ? (
            ...
            <div className="flex aspect-[9/16] w-full max-w-[280px] flex-col items-center justify-center gap-2 rounded-lg bg-surface-850 text-center text-zinc-500">
              <Film className="h-8 w-8" />
              <p className="px-4 text-xs">
                No render yet. Click “Render Clip” to produce the final 9:16 video with Remotion.
              </p>
            </div>
          )}
          {currentVersion && (
            <p className="mt-3 text-xs text-zinc-500">
              Showing Version {currentVersion.version_number} (current)
            </p>
          )}
        </div>
